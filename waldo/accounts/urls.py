...
from .views import create_collaborator, list_collaborators, detail_collaborator, edit_collaborator
...
urlpatterns = [
    ...
    path('<int:collaborator_id>/edit/', edit_collaborator, name='collaborator_edit'),
]
